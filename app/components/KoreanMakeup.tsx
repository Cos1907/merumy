...
export default function KoreanMakeup() {
  ...
  useEffect(() => {
    fetch('/api/kore-trends?section=makeup&limit=12')
      .then(r => r.json())
      .then(d => { if (d.products) setProducts(d.products.filter((p: any) => p.inStock !== false)) })
      .catch(() => {})
  }, [])
    ...
    <section className="py-6 md:py-12 bg-white">
      <div className="container mx-auto px-2 md:px-4">
        ...
        <div className="flex justify-between items-center mb-4 md:mb-8">
          <h2 
            className="text-lg md:text-3xl font-bold font-grift uppercase"
            style={{ color: '#92D0AA' }}
          >
            KOREAN MAKE UP
          </h2>
